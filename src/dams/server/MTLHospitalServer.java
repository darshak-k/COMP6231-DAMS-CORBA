...
public class MTLHospitalServer extends HospitalServerInterfacePOA {
	...
	@Override
	public String addAppointment(String appointmentID, server.AppointmentType appointmentType, int capacity) {
		// TODO Auto-generated method stub
		String response = "";
