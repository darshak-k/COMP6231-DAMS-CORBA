...
/**
* server/_HospitalServerInterfaceStub.java .
* Generated by the IDL-to-Java compiler (portable), version "3.2"
* from HospitalServer.idl
* Sunday, 20 February, 2022 11:09:53 PM EST
*/

public class _HospitalServerInterfaceStub extends org.omg.CORBA.portable.ObjectImpl implements server.HospitalServerInterface
{
  ...
  public String addAppointment (String appointmentID, server.AppointmentType appointmentType, int capacity)
  {
            ...
            try {
                ...
                server.AppointmentTypeHelper.write ($out, appointmentType);
  ...
  public String removeAppointment (String appointmentID, server.AppointmentType appointmentType)
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
  ...
  public String listAppointmentAvailability (server.AppointmentType appointmentType)
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
  ...
  public String bookAppointment (String patientID, String appointmentID, server.AppointmentType appointmentType)
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
  ...
  public String swapAppointment (String patientID, String oldAppointmentID, server.AppointmentType oldAppointmentType, String newAppointmentID, server.AppointmentType newAppointmentType)
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                ...
                server.AppointmentTypeHelper.write ($out, oldAppointmentType);
                $out.write_string (newAppointmentID);
                server.AppointmentTypeHelper.write ($out, newAppointmentType);
                $in = _invoke ($out);
                String $result = $in.read_string ();
                return $result;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
...
} // class _HospitalServerInterfaceStub
